...
def generate_video_from_data(quantum_circuit, output_manager: data_manager.DataManager, rhythm, noise_model=None, input_instruments=[list(range(81, 89))], note_map=musical_processing.note_map_chromatic_middle_c, invert_colours=False, fps=60, vpr=None, smooth_transitions=True, phase_marker=True, probability_distribution_only=False):
